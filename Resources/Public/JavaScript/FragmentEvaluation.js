/**
 * @exports TYPO3/CMS/ContentSlug/FragmentEvaluation
 */
define(
  ['require', 'TYPO3/CMS/Backend/FormEngineValidation'],
  function(require, FormEngineValidation) {
    'use strict';

    class FragmentEvaluation {
      static registerCustomEvaluation(name) {
        FormEngineValidation.registerCustomEvaluation(name, FragmentEvaluation.evaluateFragment);
      }
